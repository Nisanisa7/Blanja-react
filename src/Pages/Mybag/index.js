...
const Bag = () => {
    ...
    const [totalprice, settotslprice] = useState(0)
                ...
                <div className="container">
                    <main>
                        ...
                        <div className="row no-gutters">
                         ...
                         <button type="button" disabled={CardData.length === 0} onClick={pushCheckOut} className={`btn btn-danger ${style.btncard2}`}>Buy</button>
                    </div>
                </div>
                </div>
                        </div>
