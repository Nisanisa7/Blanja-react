...
const Register = ({ props }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(registerSeller(values, history));
    },
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className={style.formwarp}>
          <input
            ...
            className={
              formik.errors.name ? "errorborder" : style["form-control"]
            }
            placeholder="Name"
          />
          ...
          <input
            ...
            onChange={formik.handleChange}
            className={
              formik.errors.email ? "errorborder" : style["form-control"]
            }
            placeholder="Email"
          />
          ...
          <input
            ...
            onChange={formik.handleChange}
            className={
              formik.errors.phone_number ? "errorborder" : style["form-control"]
            }
          ...
          <input
            ...
            onChange={formik.handleChange}
            className={
              formik.errors.store_name ? "errorborder" : style["form-control"]
            }
          ...
          <input
            ...
            onChange={formik.handleChange}
            className={
              formik.errors.password ? "errorborder" : style["form-control"]
            }
